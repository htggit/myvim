...
let s:airline_c_normal   = [ '#ffffff' , '#008000' , 85  , 234 ]
let g:airline#themes#mine#palette.normal = airline#themes#generate_color_map(s:airline_a_normal, s:airline_b_normal, s:airline_c_normal)

" It should be noted the above is equivalent to:
" let g:airline#themes#mine#palette.normal = airline#themes#generate_color_map(
...
" let g:airline#themes#mine#palette.normal = {
...
let g:airline#themes#mine#palette.terminal = airline#themes#generate_color_map(s:airline_a_insert, s:airline_b_insert, s:airline_c_insert)

let g:airline#themes#mine#palette.replace = copy(g:airline#themes#mine#palette.insert)
let g:airline#themes#mine#palette.replace.airline_a = [ s:airline_b_insert[0]   , '#af0000' , s:airline_b_insert[2] , 124     , ''     ]
...
let s:airline_b_inactive = [ '#aeaeae' , '#262626' , 239 , 235 , '' ]
...
let g:airline#themes#mine#palette.commandline = airline#themes#generate_color_map(s:airline_a_commandline, s:airline_b_commandline, s:airline_c_commandline)
